...
        --transparent-blue-20: rgba(0, 145, 255, 0.2);
        --transparent-blue-10: rgba(29, 78, 216, 0.1);
        --highlight-yellow: #f39c12;
        --light-yellow-bg: #fff3cd;
    }
...
        border-radius: 12px;
        padding: 20px;
        background: linear-gradient(135deg, var(--light-background) 0%, #e9ecef 100%);
...
    .highlight-section {
        background: linear-gradient(135deg, var(--light-yellow-bg) 0%, #ffeaa7 100%);
...
        background: linear-gradient(135deg, var(--highlight-yellow) 0%, #e67e22 100%);
        border-color: #d68910;
        transform: scale(1.1);
    }
